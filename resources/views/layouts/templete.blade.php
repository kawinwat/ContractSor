  ...
  <body class="c-app">
      <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
        ...
        <ul class="c-sidebar-nav">
          <li class="c-sidebar-nav-title">หน้าหลัก</li>
          ...
          <li class="c-sidebar-nav-title">ตารางข้อมูล</li>
          <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="index-tor">
              <svg class="c-sidebar-nav-icon">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-description"></use>
              </svg>TOR<span class="badge badge-info">NEW</span></a>
          </li>
          <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="index-contract">
            <svg class="c-sidebar-nav-icon">
              <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-window-maximize"></use>
            </svg>สัญญา<span class="badge badge-info">NEW</span></a>
            
          </li>
          
          <li class="c-sidebar-nav-title">ข้อมูลพื้นฐาน</li>
        
          <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
              <svg class="c-sidebar-nav-icon">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-columns"></use>
              </svg> จัดการข้อมูลพื้นฐาน</a>
            <ul class="c-sidebar-nav-dropdown-items">
              <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="tables/datatables.html">คู่สัญญา<span class="badge badge-danger">PRO</span></a></li>
            </ul>
            <ul class="c-sidebar-nav-dropdown-items">
              <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="tables/datatables.html">หน่วยงาน<span class="badge badge-danger">PRO</span></a></li>
            </ul>
            <ul class="c-sidebar-nav-dropdown-items">
              <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="tables/datatables.html">Product Code<span class="badge badge-danger">PRO</span></a></li>
            </ul>
            <ul class="c-sidebar-nav-dropdown-items">
              <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="tables/datatables.html">Hardware<span class="badge badge-danger">PRO</span></a></li>
            </ul>
            <ul class="c-sidebar-nav-dropdown-items">
              <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="tables/datatables.html">Software<span class="badge badge-danger">PRO</span></a></li>
            </ul>
            <ul class="c-sidebar-nav-dropdown-items">
              <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="tables/datatables.html">Man Hour<span class="badge badge-danger">PRO</span></a></li>
            </ul>
          </li> 
          <li class="c-sidebar-nav-title">ข้อมูลผู้ใช้งานระบบ</li>
        
          <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
              <svg class="c-sidebar-nav-icon">
                <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-people"></use>
              </svg> จัดการข้อมูลผู้ใช้</a>
            <ul class="c-sidebar-nav-dropdown-items">
